            ...
            <div class="container">
                <div class="header-left">
                    ...
                    <a href="https://www.portotheme.com/html/molla/index1.html" class="logo">
                        <img src="{{asset('assets/images/demos/demo-21/logo.png')}}" alt="Molla Logo" width="100" height="25">
                    </a>
    ...
    <main class="main">
        <div class="intro-slider-container mb-5">
            <div class="intro-slider owl-carousel owl-theme owl-nav-inside owl-light" data-toggle="owl"
                ...
                <div class="intro-slide" style="background-image: url({{asset('assets/images/demos/demo-21/slider/slide-1.png')}}">
                ...
                <div class="intro-slide" style="background-image: url({{asset('assets/images/demos/demo-21/slider/slide-2.jpg')}}">
                    <div class="container intro-content">
                        <div class="row">
                            <div class="intro">
                                <div class="title">
            ...
            <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                ...
                <div class="product demo21">
                    <figure class="product-media">
                        ...
                        <a href="product.html">
                            <img src="{{asset('assets/images/demos/demo-21/bestSellers/product-1-1.jpg')}}" alt="Product image" class="product-image">
                            <img src="{{asset('assets/images/demos/demo-21/bestSellers/product-1-2.jpg')}}" alt="Product image" class="product-image-hover">
                        </a>
                ...
                <div class="product demo21">
                    <figure class="product-media">
                        ...
                        <a href="product.html">
                            <img src="{{asset('assets/images/demos/demo-21/bestSellers/product-2-1.jpg')}}" alt="Product image" class="product-image">
                            <img src="{{asset('assets/images/demos/demo-21/bestSellers/product-2-2.jpg')}}" alt="Product image" class="product-image-hover">
                        </a>
                ...
                <div class="product demo21">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{asset('assets/images/demos/demo-21/bestSellers/product-3-1.jpg')}}" alt="Product image" class="product-image">
                            <img src="{{asset('assets/images/demos/demo-21/bestSellers/product-3-2.jpg')}}" alt="Product image" class="product-image-hover">
                        </a>
                ...
                <div class="product demo21">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{asset('assets/images/demos/demo-21/bestSellers/product-4-1.jpg')}}" alt="Product image" class="product-image">
                            <img src="{{asset('assets/images/demos/demo-21/bestSellers/product-4-2.jpg')}}" alt="Product image" class="product-image-hover">
                        </a>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-6">
                            <div class="product demo21">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/demos/demo-21/chooseStyle/product-1.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                        ...
                        <div class="col-lg-4 col-md-4 col-6">
                            <div class="product demo21">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/demos/demo-21/chooseStyle/product-2.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                        ...
                        <div class="col-lg-4 col-md-4 col-6">
                            <div class="product demo21">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/demos/demo-21/chooseStyle/product-3.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                    ...
                    <div class="row">
                        <div class="col-xl-5col col-lg-3 col-md-4 col-6">
                            <div class="product demo21">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/demos/demo-21/newArrivals/product-1.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                        ...
                        <div class="col-xl-5col col-lg-3 col-md-4 col-6">
                            <div class="product demo21">
                                <figure class="product-media">
                                    <span class="product-label label-sale">Sale</span>
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/demos/demo-21/newArrivals/product-2.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                        ...
                        <div class="col-xl-5col col-lg-3 col-md-4 col-6">
                            <div class="product demo21">
                                <figure class="product-media">
                                    <span class="product-label label-sale">Sale</span>
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/demos/demo-21/newArrivals/product-3.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                        ...
                        <div class="col-xl-5col col-lg-3 col-md-4 col-6">
                            <div class="product demo21">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/demos/demo-21/newArrivals/product-4.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                        ...
                        <div class="col-xl-5col col-lg-3 col-md-4 col-6">
                            <div class="product demo21">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/demos/demo-21/newArrivals/product-5.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                        ...
                        <div class="col-xl-5col col-lg-3 col-md-4 col-6">
                            <div class="product demo21">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/demos/demo-21/newArrivals/product-6.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                        ...
                        <div class="col-xl-5col col-lg-3 col-md-4 col-6">
                            <div class="product demo21">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/demos/demo-21/newArrivals/product-7.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                        ...
                        <div class="col-xl-5col col-lg-3 col-md-4 col-6">
                            <div class="product demo21">
                                <figure class="product-media">
                                    <span class="product-label label-sale">Sale</span>
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/demos/demo-21/newArrivals/product-8.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                        ...
                        <div class="col-xl-5col col-lg-3 col-md-4 col-6">
                            <div class="product demo21">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/demos/demo-21/newArrivals/product-9.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                        ...
                        <div class="col-xl-5col col-lg-3 col-md-4 col-6">
                            <div class="product demo21">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/demos/demo-21/newArrivals/product-10.jpg')}}" alt="Product image" class="product-image">
                                    </a>
        ...
        <div class="container newsletter">
            <div class="background" style="background-image: url({{asset('assets/images/demos/demo-21/newsLetter/banner.jpg')}}">
                <div class="subscribe">
            ...
            <div class="row">
                <div class="col-2xl-5col col-md-12">
                    <div class="widget widget-about">
                        <img src="{{asset('assets/images/demos/demo-21/logo-footer.png')}}" class="footer-logo" alt="Footer Logo" width="100" height="25">
