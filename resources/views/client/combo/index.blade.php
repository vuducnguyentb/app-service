...
@section('seo_support')
    <title>{{config('batdangoai')['seo']['index-combo']['title']}}</title>
    <meta name="description" content="{{config('batdangoai')['seo']['index-combo']['description']}}">
    ...
    <meta property="og:title" content="{{config('batdangoai')['seo']['index-combo']['title']}}">
    <meta property="og:description" content="{{config('batdangoai')['seo']['index-combo']['description']}}">
    <meta property="og:url" content="{{route('client.combo')}}">
    <meta name="twitter:title" content="{{config('batdangoai')['seo']['index-combo']['title']}}">
    <meta name="twitter:description" content="{{config('batdangoai')['seo']['index-combo']['description']}}">
